...
public interface ApiPatterns {
    ...
    @GET("/api/v1/patterns")
    Call<Patterns> getPatternsById(@Query("event_id") Long id, @Header("X-Firebase-Auth") String tokenID);
    ...
    Call<Patterns> update(@Path("id") Long id, @Body DatumPatterns eventPattern, @Header("X-Firebase-Auth") String tokenID);
