...
public class AgendaCalendarView extends FrameLayout implements StickyListHeadersListView.OnStickyHeaderChangedListener {
    ...
    protected void onFinishInflate() {
        ...
        mAgendaView.getAgendaListView().setOnItemLongClickListener((AdapterView<?> parent, View view, int position, long id)->{
            mCalendarPickerController.onEventSelectedLong(CalendarManager.getInstance().getEvents().get(position));
            return true;
        });
